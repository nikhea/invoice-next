...
const style = {
  ...
  textContainer: `p-5  md:w-[55%] text-center md:text-left`,
  title: `text-[2rem] md:text-[2.5rem] font-[700]   leading-[1.3] text-white`,
  subtitle: `  my-4 text-[1.2rem] md:text-[1.5rem] font-[400]   leading-[1.8] mb-20 text-white`,
  button: `border uppercase text-white border-2 border-solid border-[#2B2B2B] bg-[#2B2B2B] font-[600] rounded-[10rem] py-5 px-10 my-10`,
